<%@ Page Title="" Language="C#" MasterPageFile="~/masterhal.Master" AutoEventWireup="true" CodeBehind="admintakelogs.aspx.cs" Inherits="I_T_help_desk_HAL.WebForm11" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <asp:Label ID="Label5" runat="server"    Style="font-size:20px" Text="Your_depertment"></asp:Label>
   ...
   <div class="gridview-container col-12">
    <asp:GridView ID="GridView1" runat="server" Class="table table-striped table-hover table-bordered" DataKeyNames="LogID" OnRowCommand="GridView1_RowCommand" >
        <Columns>
