<%@ Page Title="" Language="C#" MasterPageFile="~/masterhal.Master" AutoEventWireup="true" CodeBehind="usercreatenewlog.aspx.cs" Inherits="I_T_help_desk_HAL.WebForm5" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="css/usercreate1.css" rel="stylesheet" />
</asp:Content>
                 ...
                 <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto" style="color:white">
                      ...
                      <li class="nav-item active" style="color:white">
                            <asp:LinkButton class="nav-link"  ID="LinkButton1" runat="server" OnClick="LinkButton1_Click1">Create New Log</asp:LinkButton>
                        </li>
                    </ul>
                     <span class="welcome navbar-nav ms-auto">
                          <centre style="position: relative;right: 118px;">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0" >
                        ...
                        <li class="nav-item active">
                            <asp:LinkButton class="nav-link" ID="LinkButton2" runat="server" OnClick="LinkButton2_Click1" >Logout</asp:LinkButton>
                        </li>
                     ...
                     <div class="col-6 mx-auto">
                        <center>
                           <div class="form-group  d-grid gap-2">
                              <asp:Button class="btn btn-success btn-block btn-lg" ID="Button1" runat="server" Text="Create" OnClick="Button1_Click1" />
                           </div>
                        </center>
                         <br />
                     </div>
                      <div class="col-6 mx-auto">
                        <center>
                           <div class="form-group  d-grid gap-2">
                              <asp:Button class="btn btn-primary btn-block btn-lg" ID="Button2" runat="server"   Text="Clear" OnClick="Button2_Click1" />
                           </div>
                        </center>
                         <br />
                     </div>
