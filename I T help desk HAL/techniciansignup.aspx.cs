    ...
    public partial class WebForm18 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                string technicianID = TextBox8.Text; // Set this to the desired username (e.g., emailID)
                ...
                InsertAdminData(technicianID, fullName, dateOfBirth, contact, emailID, department, departmentNo, designation, employeeID, password);
        ...
        private void InsertAdminData(string technicianID, string fullName, string dateOfBirth, string contact, string emailID, string department, string departmentNo, string designation, string employeeID, string password)
        {
            // Implement the database connection and SQL query here to insert data into the Admins_table
            // Example code:
            string connectionString = ConfigurationManager.ConnectionStrings["con"].ConnectionString;

            string query = @"INSERT INTO Technicians_table (TechnicianID, FullName, DateOfBirth, Contact, EmailID, Department, DepartmentNo, Designation, EmployeeID, Password) 
                               VALUES (@TechnicianID, @FullName, @DateOfBirth, @Contact, @EmailID, @Department, @DepartmentNo, @Designation, @EmployeeID, @Password)";
