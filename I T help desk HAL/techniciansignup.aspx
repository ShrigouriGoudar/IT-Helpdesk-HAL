<%@ Page Title="" Language="C#" MasterPageFile="~/masterhal.Master" AutoEventWireup="true" CodeBehind="techniciansignup.aspx.cs" Inherits="I_T_help_desk_HAL.WebForm18" %>
  ...
  object-fit: cover;" />
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox8" runat="server" placeholder="Technician ID" ></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-6">
