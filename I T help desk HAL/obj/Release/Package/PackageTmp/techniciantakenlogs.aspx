<%@ Page Title="" Language="C#" MasterPageFile="~/masterhal.Master" AutoEventWireup="true" CodeBehind="techniciantakenlogs.aspx.cs" Inherits="I_T_help_desk_HAL.WebForm20" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="css/takelog.css" rel="stylesheet" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                 ...
                 <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto" style="color:white">
                        <li class="nav-item active">
                            <a class="nav-link" href="technicianhome.aspx">Home</a>
                        </li>
    ...
    overflow-y: auto;">
      ...
      <div class="row"  style="max-width: 100%; padding: 0;">
         <div class="container-box col-md mx-auto mt-2  mb-2" >
            <div class="">
               <div class="">
                  <div class="row">
                     <div class="col">
  ...
  <asp:Label ID="Label2" runat="server"    Style="font-size:20px" Text="Your_Name"></asp:Label>
                     ...
                     <div class="col-md-6">
                        <label Style="font-size:20px">Technician ID: </label>
  ...
  <asp:Label ID="Label5" runat="server"    Style="font-size:20px" Text="Your_depertment"></asp:Label>
   ...
   <div class="gridview-container col-12">
    <asp:GridView ID="GridView1" runat="server" Class="table table-striped table-hover table-bordered" OnRowCommand="GridView1_RowCommand">
         <Columns>
            <asp:TemplateField HeaderText="Case Action">
                <ItemTemplate>
                    
                    <center>
                        <asp:HyperLink ID="hlLogID" runat="server" CommandName="ViewLogDetails" Text='<%# Eval("LogID") %>' NavigateUrl='<%# "technicianlogdetails.aspx?LogID=" + Eval("LogID") %>' />
                    </center>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
            ...
            <a href="technicianhome.aspx" style="color:white"><< Back to Home</a><br><br>
         </div>
         </div>
      </div>
   </div>
