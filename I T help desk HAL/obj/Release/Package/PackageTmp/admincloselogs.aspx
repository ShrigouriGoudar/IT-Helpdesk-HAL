<%@ Page Title="" Language="C#" MasterPageFile="~/masterhal.Master" AutoEventWireup="true" CodeBehind="admincloselogs.aspx.cs" Inherits="I_T_help_desk_HAL.WebForm13" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="css/closelog.css" rel="stylesheet" />
</asp:Content>
                ...
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                 ...
                 <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto" style="color:white">
                     ...
                     <span class="welcome navbar-nav ms-auto">
    ...
    <asp:GridView ID="GridView1" runat="server" Class="table table-striped table-hover table-bordered" OnRowCommand="GridView1_RowCommand">
         <Columns>
            <asp:TemplateField HeaderText="Case Action">
                <ItemTemplate>
                    <asp:Button ID="btnTake" Text="Close" runat="server" CommandName="CloseLog" CommandArgument='<%# Eval("LogID") %>' AutoPostBack="false" OnClientClick="return confirm('Are you sure you want to Close this log?');" />
                    <center>
                        <asp:HyperLink ID="hlLogID" runat="server" CommandName="ViewLogDetails" Text='<%# Eval("LogID") %>' NavigateUrl='<%# "admindetails2.aspx?LogID=" + Eval("LogID") %>' />
                    </center>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
            ...
            <a href="adminhome.aspx" style="color:white"><< Back to Home</a><br><br>
         </div>
         </div>
      </div>
   </div>
