<%@ Page Title="" Language="C#" MasterPageFile="~/masterhal.Master" AutoEventWireup="true" CodeBehind="admincreatelogs.aspx.cs" Inherits="I_T_help_desk_HAL.WebForm14" %>
                     ...
                     <div class="col-6 mx-auto">
                        <center>
                           <div class="form-group  d-grid gap-2">
                              <asp:Button class="btn btn-success btn-block btn-lg" ID="Button1" runat="server" Text="Create" OnClick="Button1_Click" />
                           </div>
                        </center>
                         <br />
                     </div>
