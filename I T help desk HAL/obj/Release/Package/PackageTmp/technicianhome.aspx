<%@ Page Title="" Language="C#" MasterPageFile="~/masterhal.Master" AutoEventWireup="true" CodeBehind="technicianhome.aspx.cs" Inherits="I_T_help_desk_HAL.WebForm19" %>
    ...
    <asp:GridView ID="GridView1" runat="server" Class="table table-striped table-hover table-bordered" OnRowCommand="GridView1_RowCommand">
         <Columns>
            <asp:TemplateField HeaderText="Case Action">
                <ItemTemplate>
                    <asp:Button ID="btnTake" Text="Take" runat="server" CommandName="TakeLog" CommandArgument='<%# Eval("LogID") %>' AutoPostBack="false" OnClientClick="return confirm('Are you sure you want to take this log?');" />
                    <center>
