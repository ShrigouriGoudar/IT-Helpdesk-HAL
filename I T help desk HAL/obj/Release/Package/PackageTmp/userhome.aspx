<%@ Page Title="" Language="C#" MasterPageFile="~/masterhal.Master" AutoEventWireup="true" CodeBehind="userhome.aspx.cs" Inherits="I_T_help_desk_HAL.WebForm6" %>
...
<div class="gridview-container col-12">
 <asp:GridView ID="GridView1" runat="server" CssClass=" table table-striped table-hover table-bordered table-responsive-lg"  OnRowCommand="GridView1_RowCommand1" OnRowDataBound="GridView1_RowDataBound"   >
    ...
    <Columns>
        <asp:TemplateField HeaderText="Case Action">
            <ItemTemplate>
                ...
                <center>
                <asp:HyperLink ID="hlLogID" runat="server" CommandName="ViewLogDetails" Text='<%# Eval("LogID") %>' NavigateUrl='<%# "userlogdetails.aspx?LogID=" + Eval("LogID") %>' />
                </center>
            </ItemTemplate>
        </asp:TemplateField>
