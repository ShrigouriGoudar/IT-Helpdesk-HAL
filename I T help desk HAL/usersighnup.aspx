<%@ Page Title="" Language="C#" MasterPageFile="~/masterhal.Master" AutoEventWireup="true" CodeBehind="usersighnup.aspx.cs" Inherits="I_T_help_desk_HAL.WebForm4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  object-fit: cover;" />
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <span class="badge badge-pill badge-info" > <h5>Login Credentials</h5></span>
                        </center>
                     </div>
                  </div>
                   <hr />
